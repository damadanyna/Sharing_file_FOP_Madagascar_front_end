...
<div class=" p-3 flex flex-col">
    ...
    <formulaire v-if="this.$store.state.show_pres_form" class=" fixed top-0 left-0"></formulaire>
        ...
        <div class=" flex flex-col mt-2 h-full w-full ">
            <div class="flex flex-row mt-5 ">
                <div class="border-b-4 border-indigo-500 flex px-5">
                    <div class="  ">
                        <span :class="this.$store.state.is_dark?'text-gray-400':'text-gray-800'" class=" font-bold ">Liste des Presences</span>
                    </div>
                    <div class="   flex flex-row ">
            ...
            <div class=" mt-5 h-full w-full  ">
                <div class="flex w-full h-full ">
                    <div v-if="!this.$store.state.liste_presence.length>0" class="flex flex-col w-full h-full items-center justify-center">
                    ...
                    <div v-else class="flex h-full w-full">
                        <div class=" grid grid-cols-2  overflow-auto sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 2xl:grid-cols-6 w-full">
                            <div v-for="item,i in this.$store.state.liste_presence" :key="i" class=" w-56 h-44 flex rounded-lg my-2  px-3 flex-col border border-gray-500 ">
...
import formulaire from "./presence/presenceView.vue"
export default {
    components: {
        formulaire,
        historique,
